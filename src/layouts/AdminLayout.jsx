...
import adminPortalBg from '../assets/temp/adminportal_bg.png';
...
export const AdminLayout = () => {
  ...
  const getHeaderTitle = () => {
    ...
    if (!path || path === 'dashboard' || path === 'admin') return 'System Overview';
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-dark-bg text-white pt-16 lg:pt-0">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${adminPortalBg})`,
          ...
          <header className="h-20 border-b border-dark-border/60 flex items-center justify-between px-8 bg-dark-card/25 backdrop-blur-xs flex-shrink-0">
            <div className="flex items-center gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-xs text-muted-text mt-0.5">Platform Controller & Compliance Console</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold">
                Super Admin
              </div>
            </div>
          </header>
